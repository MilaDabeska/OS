...
public class TancSoStudentite {
    ...
    static Semaphore maleRoom;
    static Semaphore womanRoom;
    static Semaphore dancingRoom;
    static Semaphore partner;


    public void init() {
        //TODO: da se implementira
        maleRoom = new Semaphore(10);
        womanRoom = new Semaphore(10);
        dancingRoom = new Semaphore(3);
        partner = new Semaphore(0);
    }
    ...
    class Masko extends Thread {
        ...
        public void ucestvo() throws InterruptedException {
            ...
            partner.acquire(); //По пресоблекувањето, учесниците чекаат да дојде произволен партнер
            dancingRoom.acquire(); //влегуваат во салата за танцување
            show.tancuvaj();
            dancingRoom.release(); //По завршувањето на танцот, паровите излегуваат од салата
        }
